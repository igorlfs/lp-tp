...
fun run exp = 
    ...
    | UnknownType => "Unknow type: o tipo da expressão passada é desconhecido e não pode ser verificado"
    ...
    | MatchResTypeDiff => "MatchResTypesDiff: o tipo de retorno de um ou mais casos na expressão 'match' é diferente dos demais casos"
