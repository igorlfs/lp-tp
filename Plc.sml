...
fun run exp = 
    ...
    | UnkownType => "Unknow type: o tipo da expressão passada é desconhecido e não pode ser verificado"
    ...
    | MatchesResTypeDiff => "MatchResTypesDiff: o tipo de retorno de um ou mais casos na expressão 'match' é diferente dos demais casos"
